...
/**
 * Servlet implementation class CustomerConfirmOrderChangeController
 */
@WebServlet("/CustomerConfirmOrderChangeController")
public class CustomerConfirmOrderChangeController extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerConfirmOrderChangeController() {
        super();
        ...
        if (AppSession.isAuthenticated()) {
            if (AppSession.hasRole(AppSession.CUSTOMER_ROLE)) {
                ...
                if (!vadilator.checkOrderParam(item_size_string,
                    ...
                    CustomerServices.changeOrderService(user, order_id,
                            item_size, item_weight, address);
